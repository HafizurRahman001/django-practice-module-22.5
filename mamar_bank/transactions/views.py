...
from transactions.constants import DEPOSIT, WITHDRAWAL,LOAN, LOAN_PAID, TRANSFERRED, RECEIVED
...
class MoneyTransferView(LoginRequiredMixin, View):
    ...
    def get(self, request):
        return render(request, "transactions/transfer_money.html", {"form": MoneyTransferForm, "title" : "Money Transfer"})
    ...
    def post(self,request):
        ...
        if form.is_valid():
            ...
            isBankAccountExists = UserBankAccount.objects.filter(account_no=account_no).count()
